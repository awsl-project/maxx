...
func (s *ManagedServer) setupRoutes() *http.ServeMux {
	...
	if s.config.AuthMiddleware != nil {
		...
		mux.Handle("/api/providers", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/providers/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/routes", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/routes/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/projects", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/projects/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/retry-configs", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/retry-configs/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/provider-stats", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/api-tokens", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/api-tokens/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/model-mappings", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/model-mappings/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/settings", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/settings/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/model-prices", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/model-prices/", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
		mux.Handle("/api/response-models", http.StripPrefix("/api", s.config.AuthMiddleware.Wrap(components.SelfServiceHandler)))
	} else {
		mux.Handle("/api/admin/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.AdminHandler)))
		mux.Handle("/api/providers", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/providers/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/routes", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/routes/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/projects", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/projects/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/retry-configs", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/retry-configs/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/provider-stats", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/api-tokens", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/api-tokens/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/model-mappings", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/model-mappings/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/settings", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/settings/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/model-prices", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/model-prices/", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
		mux.Handle("/api/response-models", http.StripPrefix("/api", handler.NoAuthMiddleware(components.SelfServiceHandler)))
	}
