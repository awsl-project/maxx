...
func validateSystemSettingValue(key, value string) error {
	...
	case domain.SettingKeyForceRetryUpstreamErrors, domain.SettingKeyOpenAIChatStreamTimeoutsEnabled, domain.SettingKeyRequestFailureDetailsEnabled, domain.SettingKeyProxyRequestsDisabled, domain.SettingKeyLANAccessEnabled:
